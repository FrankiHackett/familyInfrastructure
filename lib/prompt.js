...
export async function collectAppEnvVars(cfg, appName, iface) {
  ...
  console.log('  About to inject env vars into Vercel. Does this app need any additional')
  console.log('  variables beyond the standard ones (e.g. VITE_USER_NAME, custom API keys)?')
